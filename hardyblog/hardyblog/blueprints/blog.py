...
from hardyblog.models import Post, Category,Comment
from hardyblog.forms import CommentForm, AdminCommentForm
...
def show_post(post_id):
    ...
    if current_user.is_authenticated:
        ...
        form.email.data = ','.join(current_app.config['ADMINS'])
...
@blog_bp.route('/blog/swith-theme/<theme_name>')        
